 ...
 */
public class RstaFindAndReplaceDemo extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                RstaFindAndReplaceDemo demo = new RstaFindAndReplaceDemo();
